	...
	public static void ClienElige(HashMap<String, Integer> preuPlat){
	 ...
	 while(!elige.equals("No") ) {
		 ...
		 try {
			 ...
			 throw new IOException("No tenemos este plato");
		...
		throw new InputMismatchException("Desea seguir ordenando comida? :");
...
public static void main(String[] args){
	...
	case 2:
		 Nivell2.muestraPlat(preuPlat);
		 break;
		 
	case 3:		
		Nivell2.ClienElige(preuPlat);
		 break;
	case 4:
		default:
