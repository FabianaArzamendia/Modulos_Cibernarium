...
public class Nivell3 {
	...
	public static void main(String[] args) {
		...
		case 1:
			try {
				Nivell3.IngresarPlats();
			}catch(MiexceptionTipos ex) {
				System.out.println("Debes ingresar un entero positivo para los precios");
		...
		case 2:
			 Nivell3.muestraPlat(preuPlat);
			 break;
			 
		case 3:
			try {
				 Nivell3.ClienElige(preuPlat);
			}catch(RevisionPlats ex) {
				System.out.println("Ingresa un nombre de plato valido");
			}
...
public static void IngresarPlats()throws MiexceptionTipos {
		HashMap<String, Integer> preuPlat = new HashMap<String, Integer>();
		...
		for(int i = 0 ; i < 10 ; i++) {
			...
			System.out.println("Ingresa el nombre del plato " + i);
			plats[i] = sc .nextLine();
			
			throw new MiexceptionString();
			}catch(MiexceptionString e) {
				System.out.println("Ingresa un string");
				
			}
			System.out.println("Ingresa el precio del plato " + i);
			preus[i] = sc.nextInt();
			if(preus[i] <= 0 ) {
				throw new MiexceptionTipos();
				
			}							 
			preuPlat.put(plats[i], preus[i]);
			System.out.println(preuPlat);
...
public static void ClienElige(HashMap<String, Integer> preuPlat)throws RevisionPlats {
